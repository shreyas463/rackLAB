# RackLab — Original Product Brief

> This is the original design brief the project was built from. For build/run
> instructions and an overview of what's implemented, see the top-level
> [README](../README.md).
